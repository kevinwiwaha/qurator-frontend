...
import { X, Mail, Phone, Flag, User, Users, Trophy } from "lucide-react"
...
interface RacerDetailDialogProps {
  open: boolean
...
export function RacerDetailDialog({ open, onOpenChange, racer, onUpdate }: RacerDetailDialogProps) {
        ...
        <div className="flex flex-col max-h-[85vh]">
          ...
          <div className="p-6 border-b">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold">Racer Profile</h2>
              <Button variant="ghost" size="icon" onClick={() => onOpenChange(false)} className="h-9 w-9">
                <X className="h-5 w-5" />
              </Button>
            </div>
            <p className="text-sm text-muted-foreground">View and edit racer information</p>
          </div>
